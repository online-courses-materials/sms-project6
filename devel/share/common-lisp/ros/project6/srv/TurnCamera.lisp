...
(cl:defmethod cl:initialize-instance :after ((m <TurnCamera-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnCamera-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project6-srv:<TurnCamera-request> is deprecated: use project6-srv:TurnCamera-request instead.")))

(cl:ensure-generic-function 'deg_turn-val :lambda-list '(m))
(cl:defmethod deg_turn-val ((m <TurnCamera-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project6-srv:deg_turn-val is deprecated.  Use project6-srv:deg_turn instead.")
  (deg_turn m))
...
(cl:defmethod cl:initialize-instance :after ((m <TurnCamera-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnCamera-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project6-srv:<TurnCamera-response> is deprecated: use project6-srv:TurnCamera-response instead.")))

(cl:ensure-generic-function 'camera_image-val :lambda-list '(m))
(cl:defmethod camera_image-val ((m <TurnCamera-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project6-srv:camera_image-val is deprecated.  Use project6-srv:camera_image instead.")
  (camera_image m))
